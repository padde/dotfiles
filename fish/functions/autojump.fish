# Wrapper for autojump. TODO: Remove when available from official release via Homebrew.
#
# Source:
# https://github.com/joelthelion/autojump/blob/e72369c1a99540fcafcca50c3f70847dd2bacc43/bin/autojump.fish
